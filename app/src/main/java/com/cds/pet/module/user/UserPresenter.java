...
import com.cds.pet.data.entity.WorkStateReq;
...
public class UserPresenter implements UserContract.Presenter{
    ...
    @Override
    public void updateWorkState(String state) {
        String userId = PreferenceUtils.getPrefString(App.getInstance(),PreferenceConstants.USER_ID,"");
        WorkStateReq req = new WorkStateReq(userId,state);
        mHttpApi.updateWorkState(new Gson().toJson(req))
