...
import com.cds.pet.service.message.ContentMsg;
import com.cds.pet.service.message.HeadMsg;
import com.cds.pet.service.message.TailMsg;
import com.cds.pet.util.AppManager;
import com.cds.pet.util.Logger;
import com.cds.pet.util.NetUtils;
import com.cds.pet.util.PreferenceConstants;
import com.cds.pet.util.PreferenceUtils;
import com.cds.pet.util.RomUtils;
...
//                    sMessage.setDeviceTypeName(response.getContent().getDetail().getDevice_type_name());
    ...
    private void createNotificationChannel(String title, String message) {
        ...
        NotificationCompat.Builder builder = new NotificationCompat.Builder(this, CHANNEL_ID)
                ...
                .setSmallIcon(R.mipmap.lovepetsicon)
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.lovepetsicon))
    ...
    public void createNotification(String title, String message) {
        ...
        Notification.Builder builder = new Notification.Builder(this)
                ...
                .setWhen(System.currentTimeMillis())
                .setSmallIcon(R.mipmap.lovepetsicon)//设置图标
                .setLargeIcon(BitmapFactory.decodeResource(getResources(), R.mipmap.lovepetsicon))
