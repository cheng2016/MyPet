...
public class Logger {
    ...
    static {
        ...
        if (isSDCardOK()) {
            defaultDir = Environment.getExternalStorageDirectory() + "/wecare/pet/logger/";
        } else {
            defaultDir = App.getInstance().getCacheDir().getAbsolutePath() + "/wecare/pet/logger";
        }
    }
